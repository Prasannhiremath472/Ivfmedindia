  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-overlay': 'linear-gradient(to right, rgba(15,23,42,0.85) 0%, rgba(30,58,138,0.6) 60%, rgba(15,23,42,0.2) 100%)',
      },
      boxShadow: {
        'card': '0 4px 20px -2px rgba(0,0,0,0.08)',
        'card-hover': '0 20px 60px -10px rgba(37,99,235,0.25)',
